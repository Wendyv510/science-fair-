...
Mr_Michael_Fox = User.create(name:"Mr. Michael Fox", email:"mfox@scs.org", password:"50yardline") 
...
Mrs_Sweet = User.create(name:"Mrs. Sweet", email:"ssweet@scs.org", password:"nora9812") 
...
Mr_Phil_Collins = User.create(name:"Mr. Phil Collins", email:"pcollins@scs.org", password:"yellowsub5678")
Eloise_Bump = Student.new(name:"Eloise Bump", grade_level:"12th", project:"Glass making")
Eloise_Bump.user = Mr_Phil_Collins 
Eloise_Bump.save 
Mr_Phil_Collins.save
